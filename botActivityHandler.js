...
class BotActivityHandler extends TeamsActivityHandler {
        ...
        */
        ...
        this.onMessage(async (context, next) => {
            ...
            case 'Hello':
                ...
                break;
            case 'enroll me cosmicshuai':
                await this.enrollUser(context);
                break;
            default:
            ...
            this.addConversationReference(context.activity, conversationReferences);
            await next();
        });
    ...
    async enrollUser(context) {
        const conversationReference = TurnContext.getConversationReference(context.activity);
        const username = conversationReference.user.name;
        const githubId = 'cosmicshuai';
        this.state[githubId] = {username: username, conversationReference: conversationReference};
        await context.sendActivity('Successfully enrolled');
    }

    addConversationReference(activity, conversationReferences) {
